    ...
    <div className={style.supportmain}>
      <div className={style.supportnav}>
        ...
        <div className={style.supportsearch}>
          <div>  <IoMdSearch  className={style.supportsearchbtn}/></div>
...
{/* 2nd list */}
          ...
          <div className={style.fandqmain1divli}>
              ...
              <ul>
                ...
                <li>• How long is activity data stored?
</li>
                <li>
                ...
                <li>
                • How to download user full activity?
                </li>
            ...
            <div className={style.fandqmain1divli}>
              <h3>Projects</h3>
              <ul>
                <li>• Can I allow creating projects for regular team members?</li>
                <li>• How can I assign a client to multiple projects at once?</li>
                <li>
            ...
            <div className={style.fandqmain1divli}>
              ...
              <ul>
                <li>• Can I delete a team member and not lose the time tracked on projects?</li>
                <li>• How can I add a team member to several projects at once?</li>
                <li>
          ...
          <div className={style.fandqmain1divli}>
              <h3>Time Off</h3>
              <ul>
                <li>• How can I find out how much vacation time I will have in a while?</li>
                <li>• Is it possible for my team members to see who and when goes on vacation?</li>
                <li>
            ...
            <div className={style.fandqmain1divli}>
              ...
              <ul>
                ...
                <li>• How to view time an employee spent working for each client?
                 
                </li>
                <li>• How to view all time entries for a particular task?</li>
                <li>• I want to get a report for a member that is set to inactive/locked.</li>
            ...
            <div className={style.fandqmain1divli}>
              ...
              <ul>
                ...
                <li>• How can I see my employee's private tasks that don't belong to any project?</li>
...
<div className={style.contactmain}>
  ...
  <div className={style.contactmainh1}>
    <h3>If you didn't find what you were looking for, you can make a support request or email <br />
      us to support@tmetric.com. We'll be glad to help you personally.</h3>
  </div>
