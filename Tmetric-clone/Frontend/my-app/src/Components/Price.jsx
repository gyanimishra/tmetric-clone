        ...
        <div>
          <div className="toggler">
            <div className="input-div">
                <span style={{fontWeight:"500", marginRight:"10px", fontSize:"20px"}}>Team Size</span>
              <input style={{padding:"5px 10px", fontSize:"20px"}} type="number" value={teamSize||1} onChange={({target}) => setTeamSize(target.value>200?200:target.value<1?1:target.value)} min="1" max="200" />
            </div>
        ...
        <div style={{ width: "50%", margin: "auto" }}>
          <div>
            <div style={{ marginTop: "30px" }}>
              ...
              <span>  </span>
              <a style={{ color: "#3070f0" }}>sign up</a>
              <span> </span>now.
            </div>
          </div>
          ...
          <div style={{ marginTop: "30px" }}>
            ...
            <a>On the subscription page click </a>
          ...
          <div style={{ marginTop: "30px" }}>
            ...
            <a>Enter your team size, select subscription plan, and click </a>
      ...
      <div className="Q-part">
        ...
        <div style={{ width: "60%", marginLeft: "25%" }}>
          ...
          <div style={{ marginTop: "30px" }}>
            ...
            <a>Please contact our sales department at </a>
